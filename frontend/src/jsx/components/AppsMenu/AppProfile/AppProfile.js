			  ...
			  <Modal show={state.post} className="modal fade" id="postModal" onHide={() => dispatch({type:'postModal'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<Button variant=""  type="button" className="btn-close"  onClick={() => dispatch({type:'postModal'})} ></Button>						
					</div>
					<div className="modal-body">
			 ...
			 {/* Link Modal */}
			  <Modal show={state.link}  className="modal fade post-input" id="linkModal" onHide={() => dispatch({type:'linkModal'})} centered>
				<div className="modal-content">
					...
					<div className="modal-body">
						<Link className="btn-social me-1 mb-1 mb-sm-0 facebook" to="/app-profile"><i className="fab fa-facebook-f" /></Link>
						<Link className="btn-social me-1 mb-1 mb-sm-0 google-plus" to="/app-profile"> <i className="fab fa-google-plus-g" /></Link>
