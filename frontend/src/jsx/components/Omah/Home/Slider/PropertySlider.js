      ...
      >
          {sliderData.map((item, ind)=>(
            <SwiperSlide  key={ind}>
              <div className="items">
                <Link to="#">
                  <img src={item.image} alt="#" className="w-100 mw-100 mb-3 rounded"/>
                </Link>
                <h5 className="fs-16 font-w600 mb-0">
                  <Link to="#" className="text-black">{item.title}</Link>
                </h5>
                <span className="fs-14 d-block mb-4">45 Connor St. London, 44523</span>
                <Link to="#" className="bgl-primary text-black p-1 ps-2 pe-2 me-3 font-w600 rounded">
                  <svg className="me-2" width={20} height={13} viewBox="0 0 20 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <Link to="#" className="bgl-primary text-black p-1 ps-3 pe-3 font-w600 rounded">
