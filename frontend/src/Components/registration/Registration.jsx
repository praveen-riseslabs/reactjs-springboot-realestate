    ...
    <div className='SignUp'>
      ...
      <form className="row g-3" onSubmit={handleSubmit(onSubmit)}>
        <div>
          ...
          <input type="text" className="form-control" id="fName" {...register("fName", { required: true, minLength: 3 })} />
          {errors.fName && (errors.fName.type === 'required' && (<span className='text-danger'>Full Name is required</span>))}
          {errors.fName && (errors.fName.type === "minLength" && (<span className="text-danger">Minimum length should be 3 characters</span>))}
        </div>
